...
#define IMG_W TRACK_W //图片宽度
#define IMG_H TRACK_H //图片高度

#define ALLOW_FAIL_PER 4 //容错率，每1<<ALLOW_FAIL_PER个点允许出现一个错误点，容错率越大越容易识别，但错误率越大
#define ITERATE_NUM    4 //迭代次数，迭代次数越多识别越精确，但计算量越大
