...
public class ColorPicker extends View {
    ...
    public ColorPicker(Context context,  AttributeSet attrs, int defStyleAttr) {
        ...
        final TypedArray array = context.getTheme().obtainStyledAttributes(attrs, R.styleable.ColorPicker, defStyleAttr, 0);
        mIndicatorColor = array.getColor(R.styleable.ColorPicker_indicatorColor, Color.WHITE);

        int or = array.getInteger(R.styleable.ColorPicker_orientation, 0);
        orientation = or == 0 ? Orientation.HORIZONTAL : Orientation.VERTICAL;

        mIndicatorEnable = array.getBoolean(R.styleable.ColorPicker_indicatorEnable, true);
    ...
    public interface OnColorPickerChangeListener {
         ...
         * @param picker ColorPickerView
         */
        void onStartTrackingTouch(ColorPicker picker);
